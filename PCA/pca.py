...
# ----- پلات مجموعه آموزش -----
X_set, y_set = X_train, y_train          # ← مستقیم از داده‌های PCA استفاده کن
...
# مهم: اینجا دیگه sc.transform نمی‌خوایم!
plt.contourf(X1, X2, 
             classifier.predict(np.array([X1.ravel(), X2.ravel()]).T).reshape(X1.shape),
             alpha = 0.75, 
             cmap = ListedColormap(('red', 'green', 'blue')))   # اگر ۳ کلاس داری، رنگ سوم هم اضافه کن
